...
@pytest.mark.parametrize(
  ...
  [(10, 0.1, 11), (-10, 0.1, -11), (-20, 0.1, -22)]
)

def test_pay_interest(account, bank, initial, interest, final):
...
@pytest.mark.parametrize("initial, final", [(-10, -10), (-5, -5), (10, 11)])

def test_student_account(bank, initial, final):
